...
/*ESTOS SON TODOS MIS PRODUCTOS ALMACENADOS*/
...
begin
	...
	BEGIN
		set @pasoreglas = 0
		set @Respuesta = 0
		set @Mensaje = @Mensaje + 'No puede eliminar su producto ya que se encuentra relacionado a una COMPRA\n' 
	END
	...
	BEGIN
		set @pasoreglas = 0
		set @Respuesta = 0
		set @Mensaje = @Mensaje + 'No puede eliminar su producto ya que se encuentra relacionado a una VENTA\n' 
	END
...
CREATE DATABASE DBSISTEMA_VENTA_ELECTRODOMESTICOS

GO

USE DBSISTEMA_VENTA_ELECTRODOMESTICOS
